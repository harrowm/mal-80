...
public:
    ...
    // CPU PC tracking for watchpoints (call before cpu_.step())
    void set_cpu_pc(uint16_t pc) { last_cpu_pc_ = pc; }
...
private:
    ...
    // =========================================================================
    // CPU PC TRACKING (for watchpoint logging in write())
    // =========================================================================
    uint16_t last_cpu_pc_ = 0;
